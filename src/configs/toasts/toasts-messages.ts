...
export const toastsMessages: IToastsMessages = {
	...
	addGoalsList: {
		success: 'Список целей создан! 📝',
		loading: 'Создаем список целей...',
		error: { default: 'Произошла ошибка. Попробуйте еще раз. ⚠️' }
	},
	deleteGoalsList: {
		success: 'Список целей удален! 🗑️',
		loading: 'Удаляем список целей...',
		error: { default: 'Произошла ошибка. Попробуйте еще раз. ⚠️' }
	}
};
